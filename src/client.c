...
int main(int argc, char ** argv) {
	...
	deck[3] = IMG_Load("./png/SH13_3.png");
	deck[4] = IMG_Load("./png/SH13_4.png");
	deck[5] = IMG_Load("./png/SH13_5.png");
	deck[6] = IMG_Load("./png/SH13_6.png");
	deck[7] = IMG_Load("./png/SH13_7.png");
	deck[8] = IMG_Load("./png/SH13_8.png");
	deck[9] = IMG_Load("./png/SH13_9.png");
	...
	objet[3] = IMG_Load("./png/SH13_couronne_120x120.png");
	objet[4] = IMG_Load("./png/SH13_carnet_120x120.png");
